    ...
    return (
        <div className="carousel w-full h-[595px] mt-2">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute rounded-xl flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#2F4F4F] to-[rgba(220, 220, 220, 1)]">
                    <div className='text-white space-y-7 pl-12 w-1/2'>
                        ...
                        <h2 className='text-3xl md:text-6xl font-bold'>RoyalCrown: Discover Culinary Delights from Around the Globe</h2>
            ...
            <div id="slide2" className="carousel-item relative w-full">
                ...
                <div className="absolute rounded-xl flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#2F4F4F] to-[rgba(220, 220, 220, 1)]">
                    <div className='text-white space-y-7 pl-12 w-1/2'>
                    <h2 className='text-3xl md:text-6xlfont-bold'>RoyalCrown: Discover Culinary Delights from Around the Globe</h2>
